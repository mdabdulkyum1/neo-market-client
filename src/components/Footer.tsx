          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div variants={footerItemVariants}>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/products" className="text-gray-300 hover:text-indigo-400 transition-colors duration-200">
                    Products
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/login" className="text-gray-300 hover:text-indigo-400 transition-colors duration-200">
                    Login
                  </Link>
                </li>
                <li>
                  <Link href="/register" className="text-gray-300 hover:text-indigo-400 transition-colors duration-200">
                    Register
                  </Link>
                </li>
              </ul>
            ...
            <motion.div variants={footerItemVariants}>
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-3">
                  ...
                  <a href="mailto:support@neo-market.com" className="text-gray-300 hover:text-indigo-400 transition-colors duration-200">
          ...
          >
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-6">
                ...
                <Link href="/cookies" className="text-gray-400 hover:text-indigo-400 transition-colors duration-200 text-sm">
                  Cookie Policy
                </Link>
              </div>
            </div>
